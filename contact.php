...
<div class="page-banner">
    ...
    <div class="h2 text-white" id="lua">Liên hệ chúng tôi</div>
        ...
        <section class="content container">
            <div class="row">
                <div class="col-12 col-md-6 content-page pt-5 pb-3 border-right">
                    <h2 class="page-title text-center">Liên hệ chúng tôi</h2>
                    <div class="row box-contact">
                        <div class="col-6 border-right"><i class="fas fa-map-marker-alt"></i>
                            <h3>Địa chỉ</h3>
                            <p>22 Phố Nhổn, Q.Bắc Từ Liêm, Hà Nội</p>
                        </div>
                ...
                <div class="col-12 col-md-6 content-page pt-5 pb-3">
                    <form action="/contact" method="post" enctype="multipart/form-data"><input
                        ...
                        <div class="h2 text-center" id="yeucau">Gửi yêu cầu tới KingmenSport</div>
                        <div class="row box-contact-information">
                            ...
                            <div class="col-md-12 text-center"><button type="submit" class="btn btn-primary"><i class="fas fa-angle-double-up"></i> Gửi liên hệ</button></div>
                        </div>
                    </form>
                </div>
            </div>

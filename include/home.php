    ...
    <div class="swiper mySwiper">
		<div class="swiper-wrapper" style="margin-top: 35px">
			...
			<div class="swiper-slide">
				<div class="">
					<a href="?quanly=chitietsp&id=<?php echo $row_sanpham_sidebar['sanpham_id'] ?>"><img src="images/<?php echo $row_sanpham_sidebar['sanpham_image'] ?>" alt=""></a>
				</div>
			</div>
			<?php } ?>
		</div>
				...
				<div class="agileinfo-ads-display col-lg-12">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center">

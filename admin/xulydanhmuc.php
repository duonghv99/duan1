			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td>
							<a href="?xoa=<?php echo $row_category['category_id'] ?>" class="btn btn-primary">Xóa</a> 
							<a href="?quanly=capnhat&id=<?php echo $row_category['category_id'] ?>" class="btn btn-danger">Sửa</a>
						</td>
					</tr>
					<?php
					} 
